...
const Navbar = () => {
  ...
  return (
    <div className="w-full bg-black/0 text-black flex items-center justify-between px-4 h-16 border-b border-gray-200/20 shadow-md transition-all duration-300 ease-in-out">
      {/* Vänster: Logga */}
      <Link href="/">
